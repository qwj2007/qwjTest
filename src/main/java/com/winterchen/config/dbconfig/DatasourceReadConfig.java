...
@Configuration
@MapperScan(basePackages = "com.winterchen.dao.teacher", annotationClass = UseDatasourceRead.class, sqlSessionFactoryRef = DatasourceReadConfig.SQL_SESSION_FACTORY_NAME)
public class DatasourceReadConfig {
    ...
    @Primary
    @Bean(name = DatasourceReadConfig.SQL_SESSION_FACTORY_NAME)
